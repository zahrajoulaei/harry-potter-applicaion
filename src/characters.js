// let showAll = false;
export function displayCharacters(characters, page = 1, perPage = 4) {
    ...
    if (page === 1) prevButton.classList.add('disabled'); // Highlight the change
    ...
    for (let i = 1; i <= totalPages; i++) {
        ...
        if (i === page) pageItem.classList.add('active'); // Highlight the change
    ...
    // showMoreButton.classList.add('btn-show', 'mt-3');
    // showMoreButton.addEventListener('click', () => {
    //     showAll = !showAll;
    //     displayCharacters(characters, 1, perPage);
    // });
    // charactersContainer.appendChild(showMoreButton);
}